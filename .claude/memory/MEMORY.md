...
- [Two agents: Claude implements, Codex reviews, over one comms file](feedback-two-agent-collaboration.md) — held diff -> independent verify -> ack -> commit; Codex led the process, Claude led the code; the value was bugs a green suite is blind to
